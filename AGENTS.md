# Auto-Jobs — Codex Project Instructions
...
- CLI: commander.js
- AI: Direct API calls (Codex, Gemini, OpenAI) via unified `cli/lib/ai.js`
- MCP: Chrome DevTools MCP + Codex Computer Use MCP for browser automation
